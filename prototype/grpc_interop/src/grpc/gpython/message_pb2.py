...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  package='message',
  syntax='proto3',
  serialized_options=b'Z\016my.org/message',
  create_key=_descriptor._internal_create_key,
  serialized_pb=b'\n\rmessage.proto\x12\x07message\"\x1a\n\x07Request\x12\x0f\n\x07payload\x18\x01 \x01(\t\"\x1b\n\x08Response\x12\x0f\n\x07payload\x18\x01 \x01(\t2:\n\x07Message\x12/\n\x06Search\x12\x10.message.Request\x1a\x11.message.Response\"\x00\x42\x10Z\x0emy.org/messageb\x06proto3'
)
...
_REQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='payload', full_name='message.Request.payload', index=0,
...
_RESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='payload', full_name='message.Response.payload', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_MESSAGE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='Search',
    full_name='message.Message.Search',
    index=0,
